  ...
  describe 'as a merchant' do
    describe 'when i visit my merchant items index page' do
      ...
      it 'i see the names of the top 5 most popular items by total revenue,
        ...
        invoice_item_13 = InvoiceItem.create!(item: item_8, invoice: invoice_1, quantity: 10000, unit_price: item_8.unit_price, status: 0)
        ...
        within "#popular_item-#{item_4.id}" do
          expect(page).to have_content("Total Revenue: $186.00")
        end
        ...
        within "#popular_item-#{item_6.id}" do
          expect(page).to have_content("Total Revenue: $119.00")
        end
      ...
      it 'next to each top item, i see the date when most units were sold', :vcr do
        ...
        within "#popular_item-#{item_8.id}" do
          expect(page).to have_content("Top Selling Date: 2012-07-05")
        end

        within "#popular_item-#{item_1.id}" do
          expect(page).to have_content("Top Selling Date: 2012-04-25")
        end
