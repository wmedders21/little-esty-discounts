...
RSpec.describe 'the Admin Merchant Update page' do
  ...
  it 'takes me to the edit page for the merchant', :vcr do
  ...
  it 'goes to the edit page form which has current merchant attributes', :vcr do
    visit "/admin/merchants/#{@merchant_1.id}"
  ...
  it 'updates the information and reroutes to admin merch show', :vcr do
    visit "/admin/merchants/#{@merchant_1.id}"
